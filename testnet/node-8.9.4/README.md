...
```
docker exec -it prime-public-testnet-tools-8_9_4-prime-relay-1 cardano-cli query tip --testnet-magic 3311 --socket-path /ipc/node.socket
```
...
docker compose down
docker volume rm \
  prime-public-testnet-tools-8_9_4_db-sync-data \
  prime-public-testnet-tools-8_9_4_node-db \
  prime-public-testnet-tools-8_9_4_node-ipc \
  prime-public-testnet-tools-8_9_4_postgres \
  prime-public-testnet-tools-8_9_4_wallet-api-data
```
